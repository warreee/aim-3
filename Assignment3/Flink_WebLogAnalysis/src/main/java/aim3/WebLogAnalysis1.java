 ...
 * Which IPs visit what webpages with a rank bigger than 90 that utilize the term "Lorem"?
 * </p>
 * <p>
...
public class WebLogAnalysis1 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // After that join on visits to get the ips
        DataSet<Tuple2<Integer, String>> result =
                filterDocs.join(filterRanks)
                        .where(0).equalTo(1)
                        .projectSecond(1).join(visits)
                        .where(0).equalTo(0).projectSecond(2,0);
    ...
    public static class FilterDocByKeyWords implements FilterFunction<Tuple2<String, String>> {
        ...
        private static final String[] KEYWORDS = {" Lorem "};
    ...
    public static class FilterByRank implements FilterFunction<Tuple3<Integer, String, Integer>> {
        ...
        private static final int RANKFILTER = 90;
