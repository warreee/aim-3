...
public class SlashdotZooFriendOutDegree {
    ...
    public static void main(String[] args) throws Exception {
        ...
        directedGraph.computeWeightedDistribution(new FriendOutDegree());
    }

    public static class FriendOutDegree
