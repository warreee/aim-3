...
public class SlashdotZooInDegree {
    ...
    public static void main(String[] args) throws Exception {
        ...
        GraphWeighted directedGraph = new GraphWeighted(env, input, output,
                "SlashdotZoo - In-Degree Distribution");

        directedGraph.computeWeightedDistribution(new InDegree());
    }
    ...
    public static class InDegree
        ...
        public void flatMap(Tuple3<Long, Long, Boolean> edge, Collector<Tuple2<Long, Long>> out)
                throws Exception {
            out.collect(new Tuple2<Long, Long>(edge.f1, 1L));
        }
    }
}
