...
public class SlashdotZooOutDegree {
    ...
    public static void main(String[] args) throws Exception {
        ...
        GraphWeighted directedGraph = new GraphWeighted(env, input, output,
                "SlashdotZoo - Out-Degree Distribution");

        directedGraph.computeWeightedDistribution(new OutDegree());
    }

    public static class OutDegree
